...
<% 
    ...
    ResultSet rs=stmt.executeQuery("select course.courseid cid,course.[name] cname,student.studentid [sid],student.[name] sname from ((course join courseenrollment on course.courseid=courseenrollment.courseid) join student on student.studentid=courseenrollment.studentid) where ((approved IS NULL) or (approved!=1));");
%>
<!DOCTYPE html>
<html>
    <head>
